...
var OpenTok = function OpenTok(apiKey, apiSecret, env) {
  ...
  */
  ...
  /**
   * Change an OpenTok archive layout.
   *
   *
   * @param archiveId {String} The archive ID of the archive you want to change layout.
   ...
   * @memberof OpenTok
   */
  this.archiveLayout = archiving.archiveLayout.bind(null, apiConfig);
